...
class Model {
  ...
  const Model({this.id, required this.age, required this.name});

  Model copy({int? id, int? age, String? name}) => Model(
        id: id ?? this.id,
        age: age ?? this.age,
        name: name ?? this.name,
      );
  ...
  Map<String, Object?> toJson() =>
      {ModelDataBase.id: id, ModelDataBase.name: name, ModelDataBase.age: age};
}
